...
public class ConfigConstants {
	...
	public static final String EL_BACKUP_INCLUDE_PATTERNS = "backupIncludePatterns";
	public static final String EL_BACKUP_EXCLUDE_PATTERNS = "backupExcludePatterns";
}
